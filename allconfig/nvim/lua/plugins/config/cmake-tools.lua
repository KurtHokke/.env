...
M.osys = require("cmake-tools.osys")
-- require("cmake-tools").setup {
M.opts = {
  cmake_command = "/usr/local/cmake-3.31.7/bin/cmake", -- this is used to specify cmake command path
  ctest_command = "/usr/local/cmake-3.31.7/bin/ctest", -- this is used to specify ctest command path
